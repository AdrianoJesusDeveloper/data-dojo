...
from .views import AffiliateRedirectView, CategoryListView, ProductListView, CartView, CartItemCreateView, CartItemDetailView, CheckoutView, OrderListView, OrderCancelView, ProductQuestionListCreateView, ProductQuestionDetailView, ProductReviewListCreateView, ProductReviewDetailView
