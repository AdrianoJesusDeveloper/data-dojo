...
class SenseiUnitSource(models.Model):
    ...
    approved_ranges = models.JSONField(default=list, blank=True, help_text="Intervalos estruturados aprovados para grounding, usando páginas físicas do PDF.")
    objective = models.TextField()
...
class DidacticLesson(models.Model):
    ...
    grounding_snapshot = models.JSONField(default=dict, blank=True, help_text="Snapshot imutável das fontes e chunks realmente enviados à IA na geração.")
