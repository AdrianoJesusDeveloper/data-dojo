...
export type TocEntry = { position: number; location: string; title: string };
export type ReaderMetadata = { book: LibraryBook; total: number; toc: TocEntry[]; file_url: string };
